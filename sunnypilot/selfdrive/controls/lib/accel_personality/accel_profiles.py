...
MIN_ACCEL_PROFILES = {
  "eco":                [-.0712,  -.0713, -.0713, -.0713, -.072, -1.2, -1.2],
  "normal":             [-.0712,  -.0714, -.0714, -.0714, -.072, -1.2, -1.2],
  "sport":              [-.0713,  -.0715, -.0715, -.0715, -.072, -1.2, -1.2],
  "stock":              [-1.2,    -1.2,   -1.2,   -1.2,   -1.2,  -1.2, -1.2],
}
MIN_ACCEL_BREAKPOINTS = [0.,    1.2,    8.,    12.,   14.,   22.2,  40.]
