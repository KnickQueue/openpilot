...
# Profiles
MAX_ACCEL_PROFILES = {
  "eco":                [2.00, 2.00, 1.96, 1.54, 0.83, .572, .455, .365, .32, .10],
  "normal":             [2.00, 2.00, 1.99, 1.64, 1.00, .64,  .55, .42, .37, .15],
  "sport":              [2.00, 2.00, 2.00, 1.95, 1.25, .78,  .67, .50, .43, .20],
}
MAX_ACCEL_BREAKPOINTS = [0.,   2.,   6.,   8.,   11.,  16.,  20., 25., 30., 55.]

MIN_ACCEL_PROFILES = {
  "eco":                [-.07115,  -.0713, -.072,  -.072, -1.4, -1.4],
  "normal":             [-.07116,  -.0714, -.073,  -.073, -1.5, -1.5],
  "sport":              [-.07117,  -.0715, -.074,  -.074, -1.6, -1.6],
